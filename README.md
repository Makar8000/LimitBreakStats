...
* **Survival:** `100` / `200` / `300` per player. Surviving lethal damage using shields that would otherwise kill you. The damage used for this calculation is the raw damage dealt after debuffs, before shields.
